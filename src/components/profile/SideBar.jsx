        ...
        <aside className='flex justify-center max-md:justify-start w-full p-5 relative h-full'>
            ...
            <ul className='flex flex-col items-start gap-2'>
                ...
                <NavLink to="/user/my-order" className={({ isActive }) => `flex items-center gap-2 cursor-pointer ${isActive ? ' bg-gray-200' : ' '}  rounded-md hover:bg-gray-200 p-3 w-full`} onClick={onCloseDashBoardHandler}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path strokeDasharray="2" strokeDashoffset="2" d="M4 5h0.01"><animate fill="freeze" attributeName="strokeDashoffset" dur="0.1s" values="2;0" /></path><path strokeDasharray="14" strokeDashoffset="14" d="M8 5h12"><animate fill="freeze" attributeName="strokeDashoffset" begin="0.1s" dur="0.2s" values="14;0" /></path><path strokeDasharray="2" strokeDashoffset="2" d="M4 10h0.01"><animate fill="freeze" attributeName="strokeDashoffset" begin="0.3s" dur="0.1s" values="2;0" /></path><path strokeDasharray="14" strokeDashoffset="14" d="M8 10h12"><animate fill="freeze" attributeName="strokeDashoffset" begin="0.4s" dur="0.2s" values="14;0" /></path><path strokeDasharray="2" strokeDashoffset="2" d="M4 15h0.01"><animate fill="freeze" attributeName="strokeDashoffset" begin="0.6s" dur="0.1s" values="2;0" /></path><path strokeDasharray="14" strokeDashoffset="14" d="M8 15h12"><animate fill="freeze" attributeName="strokeDashoffset" begin="0.7s" dur="0.2s" values="14;0" /></path><path strokeDasharray="2" strokeDashoffset="2" d="M4 20h0.01"><animate fill="freeze" attributeName="strokeDashoffset" begin="0.9s" dur="0.1s" values="2;0" /></path><path strokeDasharray="14" strokeDashoffset="14" d="M8 20h12"><animate fill="freeze" attributeName="strokeDashoffset" begin="1s" dur="0.2s" values="14;0" /></path></g></svg>
                    My Order</NavLink>
