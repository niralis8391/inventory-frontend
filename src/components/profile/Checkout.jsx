            ...
            <div className='w-full flex flex-col items-start gap-5 max-md:mt-5'>
                <div className=''>
                    <form className='text-md '>
                        ...
                        <div className='flex w-full gap-5 text-gray-500 mt-3'>
                            <label>
                                Name:
                                <input type='text' value={userData.name} name='name' className='border border-gray-300 text-black p-2 rounded-md block' />
                            </label>
                            <label>
                                Email:
                                <input type='email' name='email' value={userData.email} className='border border-gray-300 p-2 rounded-md block disabled:hover:cursor-not-allowed' disabled />
                            </label>
                        </div>
                        <div className='mt-3'>
                            <label className='text-gray-500'>
                                Phone:
                                <input type='text' name='phone' value={userData.phone} className='border text-black border-gray-300 p-2 rounded-md block' />
                            </label>
                        </div>
                        <div className='mt-8'>
                    ...
                    <div className='flex items-center gap-5 mt-5 '>
                        ...
                        <button type='button' className='capitalize w-full p-3 rounded-md border-2 border-transparent bg-amber-600/50 text-white  transition-all duration-300 ease-in-out hover:bg-amber-600/70  text-lg cursor-pointer' onClick={confirmOrder}>confirm Order</button>
                    </div>
                </div>
            </div>
