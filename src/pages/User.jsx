...
export const User = () => {
    ...
    return (
        <div className='flex w-full h-fit border-t border-b border-gray-300 relative'>
            <div className={`w-1/5 border-r border-gray-300 max-md:h-full max-md:absolute ${showDashBoard ? 'left-0' : '-left-full'} max-md:w-xs max-md:bg-white max-md:z-60 transition-all duration-300 ease-in-out`}>
