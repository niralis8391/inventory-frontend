            ...
            <div className='flex flex-col'>
                {storedItems.length > 0 ?
                    <div className=''>
                        ...
                        <p className='m-2 rounded-md capitalize p-3 bg-amber-600/50 flex items-center justify-between cursor-pointer text-white text-md' onClick={() => placeOrderHandler(storedItems)}>Proceed to checkout
                    ...
                    <p className='capitalize flex gap-3 flex-col items-center justify-center mt-44'>
                        <p className='p-3 text-white rounded-full bg-amber-600'>
